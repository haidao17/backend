...
*	系统消息提示
**/
function _message($string=null,$defurl=null,$time=1,$config=null){
	...
	$time=intval($time);if($time<1){$time=1;}
...
*	手机消息提示
**/
function _messagemobile($string=null,$defurl=null,$time=1,$config=null){
	if(empty($defurl)){
		$defurl=G_HTTP_REFERER;
		if(empty($defurl))$defurl=WEB_PATH;
	}
