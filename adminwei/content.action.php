...
HTML;
	...
	public function goods_edit(){
		...
		if(isset($_POST['dosubmit'])){
			...
			$is_share = !empty($_POST['is_share']) ? intval($_POST['is_share']) : 1;
	...
	public function goods_add(){
		...
		if(isset($_POST['dosubmit'])){
			...
			$query_1 = $this->db->Query("INSERT INTO `@#_shoplist` (`quyu_begin`,`quyu_end`,`ex_y`,`cateid`, `brandid`, `title`, `title_style`, `title2`, `keywords`, `description`, `money`, `yunjiage`, `zongrenshu`, `canyurenshu`,`shenyurenshu`, `qishu`,`maxqishu`,`thumb`, `picarr`,`content`,`xsjx_time`,`renqi`,`pos`,`bannershop`,`renqipos`,`newpos`,`posthumb`, `time`, `is_share`) VALUES
			                                                       ('$quyu_begin','$quyu_end','".htmlspecialchars($_POST['ex_y'])."','$cateid', '$brandid', '$title', '$title_style', '$title2', '$keywords', '$description', '$money', '$yunjiage', '$zongrenshu', '$canyurenshu','$shenyurenshu', '1','$maxqishu', '$thumb', '$picarr', '$content','$xsjx_time','$goods_key_renqi','$goods_key_pos','$goods_key_bannershop','$renqipos','$newpos','$posthumb','$time','$is_share')");
